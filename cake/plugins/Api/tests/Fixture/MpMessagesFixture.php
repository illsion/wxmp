 ...
 *
 */
class MpMessagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'url' => ['type' => 'string', 'length' => 120, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '链接地址', 'precision' => null, 'fixed' => null],
        'media_url' => ['type' => 'string', 'length' => 120, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '图片链接/其他资源链接', 'precision' => null, 'fixed' => null],
        '_constraints' => [
